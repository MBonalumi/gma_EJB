...
@NamedQuery(name="StatAnswers.getLastFromUser", query="SELECT x FROM StatAnswers x, Questionnaire y WHERE x.idU=?1 AND x.idQ=y AND y.date IN (SELECT MAX(z.date) FROM Questionnaire z)")
